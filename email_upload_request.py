...
def send_emails_to_authors(auth: Authentication, event_prefix: str, email_template: str, uid: str = None):
    ...
    if email_template == "upload_request":
        if event_prefix == "a-test" or event_prefix == "v-spotlights" or event_prefix == "a-biomedchallenge" \
            or event_prefix == "a-scivis-contest" or event_prefix == "w-visxai" or event_prefix == "w-nlviz" \
                or event_prefix == "w-pdav" or event_prefix == "w-future" or event_prefix == "w-firstperson" \
            or event_prefix == "w-test" or event_prefix == "a-visap" or event_prefix == "s-vds"\
            or event_prefix == "a-ldav" or event_prefix == "w-topoinvis" or event_prefix == "w-beliv" \
                or event_prefix == "w-uncertainty" or event_prefix == "w-storygenai" or event_prefix == "w-accessible" \
                or event_prefix == "w-energyvis" or event_prefix == "w-vis4climate" or event_prefix == "w-eduvis":
            template = templates["upload_request_associated_event"]
