...
def send_emails_to_authors(auth: Authentication, event_prefix: str, email_template: str, uid: str = None):
    ...
    if email_template == "upload_request":
        ...
        elif event_prefix == "v-short" or event_prefix == "v-full" or event_prefix == "v-test":
    ...
    print(f"{len(sheet_db_papers.data)} total papers loaded, filtered for {event_prefix}, for which {len(papers)} papers will be processed.")
